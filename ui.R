        ...
        column(width = 7,
                    wellPanel(
                      tabsetPanel(
                        ...
                        tabPanel("DEG expression matrix", 
                                 br(), br(),
